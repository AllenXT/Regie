...
public class StudentServiceImpl implements StudentService{
    ...
    private final StudentRecordDAO studentRecordDAO = new StudentRecordDAOImpl();
    ...
    @Override
    public List<Course> getCoursesWithinPrerequisite(String prerequisiteCourse) {
        return courseDAO.getCoursesByPrerequisite(prerequisiteCourse);
    }
